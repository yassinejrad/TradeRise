...
import {MenuItem} from "./ConsultantMenu.model";
import {DOCUMENT} from "@angular/common";
import {NavigationEnd, Router} from "@angular/router";
import {MENU} from "./ConsultantMenu";
import MetisMenu from "metismenujs";

@Component({
  selector: 'app-consultant-side-bar',
  templateUrl: './consultant-side-bar.component.html',
  styleUrls: ['./consultant-side-bar.component.scss']
})
